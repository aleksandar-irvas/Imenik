...
<script type="text/javascript">
    ...
    {
        if (task == 'firm.cancel') {
            Joomla.submitform(task, document.getElementById('firm-form'));
        }
        else {
            
            if (task != 'firm.cancel' && document.formvalidator.isValid(document.id('firm-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_imenik&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="firm-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_IMENIK_TITLE_FIRM', true)); ?>
        <div class="row-fluid">
